...
export default async function handler(request) {
  ...
  // Se é admin via cookie sem CRON_SECRET → força testEmail pra ele mesmo
  // (impede admin de disparar email pra equipe inteira sem o secret)
  if (isAdminTest && !validCronAuth) {
    ...
    // Garante testEmail pro próprio admin
